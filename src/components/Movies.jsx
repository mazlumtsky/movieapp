...
function Movies({ dt }) {
    ...
    return (
        <div onClick={() => router.push(`/movie/${dt?.id}`)} className='w-[300px] h-[200px] relative rounded-lg transition-opacity  shadow-2xl hover:border-orange-500  cursor-pointer  border-2'>
